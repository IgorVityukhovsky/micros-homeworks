...
Под перечисленные требования подходит GitLab. Хранение различный версий кода, репозиториев, так же встроенные средства CI\CD, возможность развернуть в собственной инфраструктуре. Распространённый вариант решения заданных задач, широкое комьюнити. Секреты можно хранить в переменных проекта или посмотреть на дополнительные средства, такие как Hashicorp vault.
...
Под описанные задачи подходит стек Prometheus + Grafana + nodeexporter  
Распространённое решение, покрывает необходимые задачи, много справочной информации в открытых источниках.  
